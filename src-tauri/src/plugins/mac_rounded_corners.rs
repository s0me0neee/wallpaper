...
/// Activates the application and makes the window key.
        ...
        window
            .with_webview(|webview| {
                ...
                unsafe {
                    ...
                    // Without this the WKWebView is not the first responder even when
                    // the window is key, so keyboard events never reach JavaScript.
